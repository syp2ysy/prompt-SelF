...
from prompt_self_utils import get_query_mask_position, get_query_mask_coordinates

def calculate_metric(args, target, ours, fg_color=WHITE, bg_color=BLACK, do_crop=True):
    if do_crop:
